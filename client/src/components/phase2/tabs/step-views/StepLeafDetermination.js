...
export function StepLeafDetermination({ depth, nodes }) {
    ...
    return (_jsxs("div", { children: [_jsxs("div", { className: "mono", style: { fontSize: 10, color: "var(--tx2)", marginBottom: 8 }, children: ["LEAF DETERMINATION \u00B7 L", depth] }), !leafReady && (_jsxs("div", { style: { display: "grid", gap: 8 }, children: [_jsxs("button", { className: "btn", onClick: () => void onDetermine(), disabled: determine.isPending, children: [determine.isPending && _jsx(Spinner, {}), "determine leaf nodes"] }), determine.isPending && (_jsx("div", { style: { fontSize: 11, color: "var(--tx2)" }, children: "LLM is classifying nodes \u2014 this may take a moment..." }))] })), leafReady && (_jsxs(_Fragment, { children: [_jsx("div", { style: { display: "grid", gap: 8, maxHeight: 280, overflow: "auto" }, children: nodes.map((node) => {
                        ...
                        }) }), _jsxs("button", { className: "btn btn-pri", style: { marginTop: 8 }, onClick: () => void onConfirm(), disabled: confirm.isPending, children: [confirm.isPending && _jsx(Spinner, {}), "confirm"] })] }))] }));
}
