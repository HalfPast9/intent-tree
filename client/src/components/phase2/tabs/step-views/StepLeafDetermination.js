...
export function StepLeafDetermination({ depth, nodes }) {
    ...
    return (_jsxs("div", { children: [_jsxs("div", { className: "mono", style: { fontSize: 10, color: "var(--tx2)", marginBottom: 8 }, children: ["LEAF DETERMINATION \u00B7 L", depth] }), !leafReady && (_jsxs("button", { className: "btn", onClick: () => void onDetermine(), disabled: determine.isPending, children: [determine.isPending && _jsx(Spinner, {}), "determine leaf nodes"] })), leafReady && (_jsxs(_Fragment, { children: [_jsx("div", { style: { display: "grid", gap: 8, maxHeight: 280, overflow: "auto" }, children: nodes.map((node) => {
