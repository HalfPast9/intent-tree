...
export function RightPanel(props) {
    ...
    return (_jsxs("aside", { className: "panel", style: { borderRadius: 0, borderRight: "none", borderTop: "none", borderBottom: "none", display: "flex", flexDirection: "column" }, children: [_jsxs("div", { style: { height: 34, borderBottom: "1px solid var(--bdr)", display: "flex", alignItems: "center" }, children: [tabButton("step", "Step"), tabButton("node", "Node"), tabButton("spec", "Spec")] }), _jsxs("div", { style: { flex: 1, minHeight: 0, overflow: "auto", padding: 10 }, children: [props.activeTab === "step" && (_jsx(StepTab, { depth: props.depth, step: props.step, status: props.stepStatus, nodes: props.nodes, states: props.displayStates, definition: props.definition, timeline: props.timeline })), props.activeTab === "node" && (_jsx(NodeTab, { node: props.selectedNode, edge: props.selectedEdge, state: props.selectedNode ? props.displayStates[props.selectedNode.id] ?? null : null, depth: props.depth, onDiagnosed: props.onDiagnosed })), props.activeTab === "spec" && _jsx(SpecTab, { spec: props.spec })] })] }));
}
